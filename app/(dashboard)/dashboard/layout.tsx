...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    {
      href: "/dashboard/binomalModel",
      icon: Leaf,
      label: "Binomal pricing Model",
    },
    {
      href: "/dashboard/RigettiCompaniFacts",
      icon: TreeDeciduous,
      label: "Rigetti Companies Facts",
    },
  ];
    ...
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-1 h-full">
        ...
        <aside
          ...
          } lg:sticky lg:top-0 lg:h-screen inset-y-0 left-0 z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
